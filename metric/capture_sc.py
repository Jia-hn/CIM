...
class CAPTURE:
    def __init__(
        ...
        if stop_words:
            from metric.stop_words import stop_words_list
    ...
    def compute_score(self, gts, res, prev_gt_parsed=None, prev_cand_parsed=None, return_parse_results=False, extra_objects=None, extra_attributes=None):
        ...
        if return_parse_results:
            return object_precision, object_recall, object_f1, attribute_precision, attribute_recall, attribute_f1, cand_parsed, gt_parsed
        else:
